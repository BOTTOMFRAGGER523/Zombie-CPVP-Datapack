...
- 1. For Windows, press "win + r", then type in "%appdata%" then .minecraft > versions > (your version) saves > go to your world > datapack and put "training_zombie_datapack" in the datapack folder
#
